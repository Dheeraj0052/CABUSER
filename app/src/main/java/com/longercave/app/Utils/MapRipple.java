...
/**
 * Created by Raj Appoets on 18-06-16.
 */
public class MapRipple {
    ...
    private volatile double distance = 200;                       //distance to which ripple should be shown in metres
    ...
    private int strokewidth = 3;                          //border width of circle
    private long durationBetweenTwoRipples = 2000;      //in microseconds.
    private long rippleDuration = 2000;                //in microseconds
